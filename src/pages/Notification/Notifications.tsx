...
export default function Notifications() {
  ...
  const filtered = activeTab === 'all' ? notifications : activeTab === 'read' ? [] : notifications.filter(n => n.type === activeTab);
      ...
      <Header
        ...
        actions={
          <div className="flex gap-sm">
            <button className="btn btn-outline btn-sm"><CheckCheck size={14} /> Mark all as read</button>
            <button className="btn btn-outline btn-sm"><Trash2 size={14} /> Clear all</button>
          </div>
        }
      />
        ...
        <div className="notif-layout">
          ...
          <div className="notif-list-panel">
            ...
            <div className="notif-actions-row">
              <button className="btn btn-sm btn-outline"><Check size={12} /> Mark as read</button>
              <button className="btn btn-sm btn-outline"><Trash2 size={12} /> Delete selected</button>
              <span className="text-muted text-sm" style={{ marginLeft: 'auto' }}>7 unread notifications</span>
            </div>
          ...
          <div className="notif-detail-panel card">
            <div className="notif-detail-header">
              ...
              <button className="action-icon-btn" title="Close"><X size={14} /></button>
            </div>
            ...
            <div className="detail-actions">
              ...
              <button className="btn btn-outline"><Check size={16} /> Mark as Read</button>
              <button className="btn btn-danger"><Trash2 size={16} /> Delete Notification</button>
            </div>
          </div>
        </div>
      </div>
