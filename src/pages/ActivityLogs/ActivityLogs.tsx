...
const actionColors: Record<ActionType, string> = {
  ...
  'POD Upload': '#FF7B42', 'Login': '#00A99D', 'Archive': '#A3AED0', 'Delete': '#E31A1A',
};
        ...
        <div className="logs-layout">
          <div className="card logs-filter">
            ...
            <div className="form-group">
              ...
              <label className="check-option"><input type="checkbox" /> Upload POD <span className="check-count">98</span></label>
